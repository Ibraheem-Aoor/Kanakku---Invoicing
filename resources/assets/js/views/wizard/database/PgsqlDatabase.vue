    ...
    <div>
      ...
      <div class="row">
        ...
        <label>{{$t('wizard.database.connection')}}</label><span class="text-danger">*</span>
         <select :class="{ 'is-invalid': $v.databaseData.database_connection.$error }"
        ...
        <div class="form-group col-md-6">
          ...
          />
          <div class="invalid-feedback" v-if="$v.databaseData.database_port.$error">{{portError}}</div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <label>{{$t('wizard.database.username')}}</label><span class="text-danger">*</span>
          <input
            :class="{ 'is-invalid': $v.databaseData.database_username.$error }"
          ...
          />
           <div class="invalid-feedback" v-if="$v.databaseData.database_username.$error">{{usernameError}}</div>
        </div>
      </div>

      <div class="row">
        <div class="form-group col-md-6">
          <label>{{$t('wizard.database.password')}}</label>
          <input
