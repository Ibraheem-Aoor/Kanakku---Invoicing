												...
												<div class="table-responsive">
													<table class="table report-table">
														<tbody >
															<tr>
                                <th>Income</th>
																<td class="text-right">{{reportData.income}}</td>
															</tr>
                               <tr>
																<th colspan="2">Expenses</th>
															</tr>
															<tr v-for="item in reportData.profitLossData" :key="item.id">
																<td>{{item.categoryName}}</td>
																<td class="text-right">{{item.Amount}}</td>
															</tr>
															<tr>
																<td class="text-right report-total" colspan="2"><strong>{{reportData.totalAmount}}</strong></td>
															</tr>
														</tbody>
													</table>
												</div>
											...
											<div class="col-md-12">
												<div class="table-responsive">
													<table class="table total-report-table">
														...
														<tr>
															<th>Net Profit:</th>
															<td><span class="float-right">{{reportData.netProfit}}</span></td>
														</tr>
														</tbody>
													</table>
												</div>
...
export default {
  ...
  methods: {
    ...mapActions('reports', ['getProfitLossReport']),
    ...
    async getReportsData() {
      ...
      let response =  await this.getProfitLossReport(this.formData)
