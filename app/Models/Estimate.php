...
use Carbon\Carbon;
use Kanakku\Mail\SendEstimateMail;
use Kanakku\Traits\HasCustomFieldsTrait;
use Vinkla\Hashids\Facades\Hashids;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Spatie\MediaLibrary\HasMedia;
use Spatie\MediaLibrary\InteractsWithMedia;
use Kanakku\Traits\GeneratesPdfTrait;
...
class Estimate extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany('Kanakku\Models\EstimateItem');
    }

    public function user()
    {
        return $this->belongsTo('Kanakku\Models\User', 'user_id');
    }

    public function creator()
    {
        return $this->belongsTo('Kanakku\Models\User', 'creator_id');
    }

    public function company()
    {
        return $this->belongsTo('Kanakku\Models\Company');
    }
    ...
    {
        return $this->belongsTo('Kanakku\Models\EstimateTemplate');
    }
